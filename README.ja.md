...
`v0.3.1` は formal System Mode installer 用の現在の GitHub release です。post-adversarial-gate `main` から installer を再公開しています。この installer が PriorityGear の通常の GitHub 配布インストール経路になります。
